dataviz.xai.shap_extra.shap_violin_interactive
==============================================
...
.. code-block:: python
   ...
   fig = shap_violin_interactive(shap_values, feature_names)
   fig.show()
...
.. raw:: html
   ...
   <div class="spc-image-grid"><figure class="spc-image-slot spc-image-real"><img src="../../../../../_static/api/dataviz/xai/shap_extra/shap_violin_interactive.png" alt="shap_violin_interactive example output"><figcaption>Example output</figcaption></figure></div>
