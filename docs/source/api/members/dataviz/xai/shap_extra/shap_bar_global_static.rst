dataviz.xai.shap_extra.shap_bar_global_static
=============================================
...
.. code-block:: python
   ...
   ax = shap_bar_global_static(shap_values, feature_names)
   plt.show()
...
.. raw:: html
   ...
   <div class="spc-image-grid"><figure class="spc-image-slot spc-image-real"><img src="../../../../../_static/api/dataviz/xai/shap_extra/shap_bar_global_static.png" alt="shap_bar_global_static example output"><figcaption>Example output</figcaption></figure></div>
