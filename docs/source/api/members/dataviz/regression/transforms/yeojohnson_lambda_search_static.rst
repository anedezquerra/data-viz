dataviz.regression.transforms.yeojohnson_lambda_search_static
=============================================================
...
.. code-block:: python
   ...
   ax = yeojohnson_lambda_search_static(y)
   plt.show()
...
.. raw:: html
   ...
   <div class="spc-image-grid"><figure class="spc-image-slot spc-image-real"><img src="../../../../_static/api/dataviz/regression/transforms/yeojohnson_lambda_search_static.png" alt="yeojohnson_lambda_search_static example output"><figcaption>Example output</figcaption></figure></div>
