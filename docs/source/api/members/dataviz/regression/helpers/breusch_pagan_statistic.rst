dataviz.regression.helpers.breusch_pagan_statistic
==================================================
...
.. code-block:: python
   ...
   import numpy as np
   from dataviz.regression.helpers import breusch_pagan_statistic
   ...
   result = breusch_pagan_statistic(y_true, y_pred)
   print(result)
