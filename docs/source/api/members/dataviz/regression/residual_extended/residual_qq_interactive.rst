dataviz.regression.residual_extended.residual_qq_interactive
============================================================
...
.. autofunction:: residual_qq_interactive
...
.. code-block:: python
   ...
   fig = residual_qq_interactive(y_true, y_pred)
   fig.show()
...
.. raw:: html
   ...
   <div class="spc-image-grid"><figure class="spc-image-slot spc-image-real"><img src="../../../../_static/api/dataviz/regression/residual_extended/residual_qq_interactive.png" alt="residual_qq_interactive example output"><figcaption>Example output</figcaption></figure></div>
