dataviz.regression.importance.feature_importance_regression_interactive
=======================================================================
...
.. code-block:: python
   ...
   import numpy as np
   from dataviz.regression.importance import feature_importance_regression_interactive
   ...
   fig = feature_importance_regression_interactive(importances)
   fig.show()
...
.. raw:: html
   ...
   <div class="spc-image-grid"><figure class="spc-image-slot spc-image-real"><img src="../../../../../_static/api/dataviz/regression/importance/feature_importance_regression_interactive.png" alt="feature_importance_regression_interactive example output"><figcaption>Example output</figcaption></figure></div>
