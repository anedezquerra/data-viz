...
.. autofunction:: standardized_coefficient_plot_static
...
.. raw:: html
   ...
   <div class="spc-image-grid"><figure class="spc-image-slot spc-image-real"><img src="../../../../_static/api/dataviz/regression/coefficients/standardized_coefficient_plot_static.png" alt="standardized_coefficient_plot_static example output"><figcaption>Example output</figcaption></figure></div>
