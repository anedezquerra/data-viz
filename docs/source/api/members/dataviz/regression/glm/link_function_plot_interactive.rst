dataviz.regression.glm.link_function_plot_interactive
=====================================================
...
.. code-block:: python
   ...
   import numpy as np
   from dataviz.regression.glm import link_function_plot_interactive
   ...
   fig = link_function_plot_interactive(y_true, y_pred)
   fig.show()
...
.. raw:: html
   ...
   <div class="spc-image-grid"><figure class="spc-image-slot spc-image-real"><img src="../../../../../_static/api/dataviz/regression/glm/link_function_plot_interactive.png" alt="link_function_plot_interactive example output"><figcaption>Example output</figcaption></figure></div>
