dataviz.regression.gof.breusch_pagan_plot_interactive
=====================================================
...
.. code-block:: python
   ...
   import numpy as np
   from dataviz.regression.gof import breusch_pagan_plot_interactive
   ...
   fig = breusch_pagan_plot_interactive(y_true, y_pred)
   fig.show()
...
.. raw:: html
   ...
   <div class="spc-image-grid"><figure class="spc-image-slot spc-image-real"><img src="../../../../../_static/api/dataviz/regression/gof/breusch_pagan_plot_interactive.png" alt="breusch_pagan_plot_interactive example output"><figcaption>Example output</figcaption></figure></div>
