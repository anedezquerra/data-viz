...
.. raw:: html
   ...
   <div class="spc-image-grid"><figure class="spc-image-slot spc-image-real"><img src="../../../../../_static/api/dataviz/multivariate/pairplot/pairplot_static.png" alt="pairplot_static example output"><figcaption>Example output</figcaption></figure></div>
