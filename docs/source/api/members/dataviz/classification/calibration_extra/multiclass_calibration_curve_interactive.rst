...
.. raw:: html
   ...
   <div class="spc-image-grid"><figure class="spc-image-slot spc-image-real"><img src="../../../../_static/api/dataviz/classification/calibration_extra/multiclass_calibration_curve_interactive.png" alt="multiclass_calibration_curve_interactive example output"><figcaption>Example output</figcaption></figure></div>
