dataviz.classification.confusion_extended.normalized_confusion_matrix_static
============================================================================
...
.. autofunction:: normalized_confusion_matrix_static
...
.. raw:: html
   ...
   <div class="spc-image-grid"><figure class="spc-image-slot spc-image-real"><img src="../../../../../_static/api/dataviz/classification/confusion_extended/normalized_confusion_matrix_static.png" alt="normalized_confusion_matrix_static example output"><figcaption>Example output</figcaption></figure></div>
