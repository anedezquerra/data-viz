...
.. raw:: html
   ...
   <div class="spc-image-grid"><figure class="spc-image-slot spc-image-real"><img src="../../../../_static/api/dataviz/classification/calibration/probability_histogram_static.png" alt="probability_histogram_static example output"><figcaption>Example output</figcaption></figure></div>
