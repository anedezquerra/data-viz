dataviz.univariate.weighted.weighted_histogram_interactive
==========================================================
...
.. raw:: html
   ...
   <div class="spc-image-grid"><figure class="spc-image-slot spc-image-real"><img src="../../../../../_static/api/dataviz/univariate/weighted/weighted_histogram_interactive.png" alt="weighted_histogram_interactive example output"><figcaption>Example output</figcaption></figure></div>
