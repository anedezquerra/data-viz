...
def class_distribution_static(
    ...
    **kwargs
    ...
    """Create a static class-frequency chart for a target variable.
    ...
    Args:
        ...
        sort (bool): Configuration value for ``sort``. Defaults to ``True``.
        ascending (bool): Configuration value for ``ascending``. Defaults to ``False``.
    ...
    Example:
        ...
        result = dv.class_distribution_static(series)
        ```
...
def class_distribution_interactive(
    ...
    **kwargs
    ...
    """Create an interactive class-frequency chart for a target variable.
    ...
    Example:
        ```python
        import dataviz as dv
        result = dv.class_distribution_interactive(series)
        ```
